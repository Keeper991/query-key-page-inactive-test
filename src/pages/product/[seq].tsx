...
const getQueryKey = (seq: any) => ["product", seq];
// const getQueryKey = (seq: any) => ["product"];
...
const ProductPage = () => {
  ...
  return (
    <div>
      ...
      <Link href={`/search/${seq}`}>search</Link>
      <div>{data}</div>
...
export const getServerSideProps: GetServerSideProps = async ({ params }) => {
  ...
  await qc.prefetchQuery(getQueryKey(seq), () => ({ seq: 1234567890 }));
